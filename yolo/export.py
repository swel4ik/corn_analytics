...
TensorFlow.js:
    $ cd .. && git clone https://github.com/zldrobit/tfjs-yolov5-example.git && cd tfjs-yolo-example
    $ npm install
    $ ln -s ../../yolo/yolov5s_web_model public/yolov5s_web_model
    $ npm start
"""
...
def run(
    ...
    if any(f):
        LOGGER.info(f'\nExport complete ({time.time() - t:.2f}s)'
                    ...
                    f"\nPyTorch Hub:     model = torch.hub.load('ultralytics/yolo', 'custom', '{f[-1]}')"
