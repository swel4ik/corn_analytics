...
def attempt_download(file, repo='ultralytics/yolo'):  # from utils.downloads import *; attempt_download()
...
def gdrive_download(id='16TiPfZj7htmTyhntwcZyEEAejOUxuT6m', file='tmp.zip'):
    # Downloads a file from Google Drive. from yolo.utils.downloads import *; gdrive_download()
    t = time.time()
    file = Path(file)
