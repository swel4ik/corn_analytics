...
from yolact.data.config import cfg, mask_type, yolact_kernel_config
    ...
    def make_priors(self, conv_h, conv_w, device):
        ...
        with timer.env('makepriors'):
            if self.last_img_size != (cfg._tmp_img_w, cfg._tmp_img_h):
                ...
                self.priors = torch.FloatTensor(prior_data, device='cpu').view(-1, 4).detach()
