...
dataset_base = Config({
    ...
    'train_images': './data/corn_coco_ext',
    'train_info':   './data/corn_coco_ext/annotations.json',

    # Validation images and annotations.
    'valid_images': './data/corn_yolo/valid_coco',
    'valid_info':   './data/corn_yolo/valid_coco/annotations.json',

    # Whether or not to load GT. If this is False, eval.py quantitative evaluation won't work.
    'has_gt': True,

    # A list of names for each of you classes.
    'class_names': CORN_CLASSES,
...
kernel_dataset = dataset_base.copy({
    'name': 'Kernels dataset',
    
    'train_images': './data/kernel_yolo/kernel_train_coco',
    'train_info':   './data/kernel_yolo/kernel_train_coco/annotations.json',

    # Validation images and annotations.
    'valid_images': './data/kernel_yolo/kernel_valid_coco',
    'valid_info':   './data/kernel_yolo/kernel_valid_coco/annotations.json',

    'class_names': KERNEL_CLASSES,
...
yolact_kernel_config = coco_base_config.copy({
    'name': 'yolact_kernel',
